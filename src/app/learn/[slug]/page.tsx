...
export default async function LessonPage({
  ...
  return (
    <div className="mx-auto w-full max-w-7xl gap-10 px-5 py-8 sm:px-8 lg:grid lg:grid-cols-[240px_minmax(0,1fr)_220px]">
      <aside className="hidden lg:sticky lg:top-20 lg:block lg:h-fit lg:py-2">
      ...
      <article className="min-w-0">
        ...
        <nav className="mt-12 grid gap-4 border-t border-[var(--color-border)] pt-8 sm:grid-cols-2">
          {previous ? (
            <Link
          ...
          {next ? (
            <Link
              ...
              className="group flex flex-col gap-1 rounded-xl border border-[var(--color-border)] p-4 text-right transition-colors hover:border-[var(--color-border-strong)] sm:items-end"
            >
              <span className="text-xs uppercase tracking-wide text-[var(--color-muted)]">
                Next →
              </span>
